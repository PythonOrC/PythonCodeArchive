...
# Form implementation generated from reading ui file 'E:/Personal/Python/program/Qt/Process Image/Process_Image.ui',
# licensing of 'E:/Personal/Python/program/Qt/Process Image/Process_Image.ui' applies.
#
# Created: Sat Sep 21 18:30:42 2019
...
class Ui_process_img(object):
    def setupUi(self, process_img):
        ...
        self.pb_save_img = QtWidgets.QPushButton(self.centralwidget)
        self.pb_save_img.setObjectName("pb_save_img")
        self.verticalLayout.addWidget(self.pb_save_img)
    ...
    def retranslateUi(self, process_img):
        process_img.setWindowTitle(QtWidgets.QApplication.translate("process_img", "图像处理", None, -1))
        ...
        self.cb_filter_list.setItemText(6, QtWidgets.QApplication.translate("process_img", "素描风格转化", None, -1))
        self.cb_filter_list.setItemText(7, QtWidgets.QApplication.translate("process_img", "字符画风格转化", None, -1))
        ...
        self.pb_save_img.setText(QtWidgets.QApplication.translate("process_img", "保存处理结果", None, -1))
